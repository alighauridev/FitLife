        ...
        <div className="px-6 py-8 mx-auto flex items-center sm:flex-row flex-col">
          <Link to="/">
            <span className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900 dark:text-gray-100">
              ...
              <span className="ml-3 text-xl">FitLife</span>
            </span>
          </Link>
          <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4 dark:text-gray-100">
            © 2023 - 2024 FitLife —
            <a
              href="https://www.linkedin.com/in/alighouridev/"
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            {/* <a
              ...
              href="https://www.facebook.com/alighauridev"
              target="_blank"
            >
              <svg
                fill="currentColor"
            ...
            <a
              ...
              href="https://twitter.com/AliGhauriDev"
              target="_blank"
            >
              <svg
                fill="currentColor"
            ...
            {/* <a
              ...
              href="https://www.instagram.com/alighauridev/"
              target="_blank"
            >
              <svg
                fill="none"
