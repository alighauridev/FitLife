...
const ExerciseVideos = ({ exerciseVideos, name }) => {
  return (
    <section className="font-body">
      <div className="mt-5 md:mt-32 p-5 container mx-auto max-w-screen-xl">
        <h3 className="ml-5 text-3xl font-bold mb-9 text-center lg:text-start dark:text-gray-100">
          Watch{" "}
          <span className="text-indigo-700 capitalize dark:text-indigo-500">
            {name}
          </span>{" "}
          Exercise
        </h3>
              ...
              .map(({ video }, index) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <h5 className="text-sm text-slate-600 font-semibold dark:text-gray-400">
                      {video.channelName}
                    </h5>
                  </div>
                </a>
